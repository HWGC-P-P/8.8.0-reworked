...
{
	public class Form_LabProvider_feedersel : Form
	{
		...
		public Form_LabProvider_feedersel(USR_STACKLIB lib)
		{
			InitializeComponent();
			mStackLib = lib;
		...
		private void InitializeComponent()
		{
			...
			base.ClientSize = new System.Drawing.Size(1274, 94);
			...
			base.Name = "Form_LabProvider_feedersel";
